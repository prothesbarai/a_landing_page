      ...
      body: ListView(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text("Get Paikaree Membership Card Now",style: TextStyle(color: AppColor.primaryColor,fontSize: 20, fontWeight: FontWeight.bold),textAlign: TextAlign.center,),
          ),
